from agikb.interface import AgikbQueryEngine
...
class SimpleAgikbQueryEngine(AgikbQueryEngine):
    def query(self, query_string: str, model: str = None) -> tuple:
        ...
        query_results = (
            AgikbQueryEngine.client.query.get(
                class_name="Chunk",
    ...
    def retrieve_document(self, doc_id: str) -> dict:
        ...
        """
        document = AgikbQueryEngine.client.data_object.get_by_id(
            doc_id,
            class_name="Document",
        )
        return document
    ...
    def add_semantic_cache(self, query: str, results: list[dict], system: str) -> None:
        ...
        @returns None
        """
        with AgikbQueryEngine.client.batch as batch:
            batch.batch_size = 1
            properties = {
                "query": str(query),
            ...
            AgikbQueryEngine.client.batch.add_data_object(properties, "Cache")
