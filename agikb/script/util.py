...
def setup_client() -> Optional[Client]:
    ...
    weaviate_url = os.environ.get("AGIKB_URL", "")
    weaviate_key = os.environ.get("AGIKB_API_KEY", "")
    ...
    # Weaviate Embedded
        ...
        msg.info("AGIKB_URL environment variable not set. Using Weaviate Embedded")
        client = weaviate.Client(
            additional_headers={"X-OpenAI-Api-Key": openai.api_key},
            embedded_options=EmbeddedOptions(
                persistence_data_path="./.agikb/local/share/",
                binary_path="./.agikb/cache/weaviate-embedded",
            ),
        )
        ...
        msg.warn("AGIKB_API_KEY environment variable not set")
